...
Bio::EnsEMBL::Xref::DBSQL::BaseXrefAdaptor

=head1 DESCRIPTION

Base adaptor for storing and retrieving objects from MySQL xref database

Provides basic methods

=cut

package Bio::EnsEMBL::Xref::DBSQL::BaseXrefAdaptor;
