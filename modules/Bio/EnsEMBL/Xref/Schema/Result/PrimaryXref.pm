...
package Bio::EnsEMBL::Xref::Schema::Result::PrimaryXref;

=head1 NAME

Bio::EnsEMBL::Xref::Schema::Result::PrimaryXref
...
__PACKAGE__->has_one('xref', 'Bio::EnsEMBL::Xref::Schema::Result::Xref', 'xref_id' );
1;
