...
package Bio::EnsEMBL::Xref::Schema::Result::Xref;

=head1 NAME

Bio::EnsEMBL::Xref::Schema::Result::Xref
...
__PACKAGE__->might_have('object_xref', 'Bio::EnsEMBL::Xref::Schema::Result::ObjectXref','xref_id'); # Not true until after the mapping is completed
__PACKAGE__->has_one('source', 'Bio::EnsEMBL::Xref::Schema::Result::Source', 'source_id');
__PACKAGE__->has_many('synonym', 'Bio::EnsEMBL::Xref::Schema::Result::Synonym', 'xref_id' );
