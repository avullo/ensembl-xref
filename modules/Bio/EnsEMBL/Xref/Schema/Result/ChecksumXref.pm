...
package Bio::EnsEMBL::Xref::Schema::Result::ChecksumXref;

=head1 NAME

Bio::EnsEMBL::Xref::Schema::Result::ChecksumXref
...
__PACKAGE__->has_one('xref', 'Bio::EnsEMBL::Xref::Schema::Result::Xref', { 'foreign.xref_id' => 'self.checksum_xref_id' });
