...
use utf8;
package Bio::EnsEMBL::Xref::Schema::Result::MappingJob;

=head1 NAME

Bio::EnsEMBL::Xref::Schema::Result::MappingJob
...
__PACKAGE__->has_one('job', 'Bio::EnsEMBL::Xref::Schema::Result::Mapping', 'job_id' );
1;
