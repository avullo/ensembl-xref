...
package Bio::EnsEMBL::Xref::Schema::Result::CoordinateXref;

=head1 NAME

Bio::EnsEMBL::Xref::Schema::Result::CoordinateXref
...
__PACKAGE__->has_one('xref', 'Bio::EnsEMBL::Xref::Schema::Result::Xref', { 'foreign.xref_id' => 'self.coord_xref_id' });
