...
use Bio::EnsEMBL::Xref::Parser::MIMParser;
...
EOF
    ;
  ok( ! defined Bio::EnsEMBL::Xref::Parser::MIMParser::extract_ti( $TI_TRUNCATED ),
...
EOF
    ;
  ok( ! defined Bio::EnsEMBL::Xref::Parser::MIMParser::extract_ti( $NO_TI ),
...
EOF
    ;
  is( Bio::EnsEMBL::Xref::Parser::MIMParser::extract_ti( $TI_MIDDLE_OF_RECORD ),
      $TI_CONTENT,
...
EOF
    ;
  is( Bio::EnsEMBL::Xref::Parser::MIMParser::extract_ti( $TI_END_OF_RECORD ),
      $TI_CONTENT,
...
EOF
    ;
  is( Bio::EnsEMBL::Xref::Parser::MIMParser::extract_ti( $TI_END_OF_FINAL_RECORD ),
      $TI_CONTENT,
...
subtest 'parse_ti()' => sub {
  ...
  ( $type_symbol, $omim_number, $description )
    = Bio::EnsEMBL::Xref::Parser::MIMParser::parse_ti( $TI_CONTENT );
  ...
  ( $type_symbol, $omim_number, $description )
    = Bio::EnsEMBL::Xref::Parser::MIMParser::parse_ti(
...
subtest 'Missing required source IDs' => sub {
  ...
  $parser = Bio::EnsEMBL::Xref::Parser::MIMParser->new(
...
subtest 'Successful inserts' => sub {
  ...
  isa_ok( $parser, 'Bio::EnsEMBL::Xref::Parser::MIMParser', 'Instantiated OMIM parser' );
  lives_ok( sub { $parser->run(); }, 'Parsed OMIM data without errors' );
};
...
subtest 'Replay safety' => sub {
  ...
  lives_ok( sub { $parser->run(); }, 'Re-parsed OMIM data without errors' );
