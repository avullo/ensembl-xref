...
use Bio::EnsEMBL::Xref::Parser::Mim2GeneParser;
...
subtest 'Missing required source IDs' => sub {
  ...
  $parser = Bio::EnsEMBL::Xref::Parser::Mim2GeneParser->new(
...
$db->schema->populate( 'Source', [
  ...
  [ $SOURCE_ID_ENTREZGENE,  'EntrezGene', 0 ],
...
subtest 'Successful inserts' => sub {
  ...
  isa_ok( $parser, 'Bio::EnsEMBL::Xref::Parser::Mim2GeneParser',
          'Instantiated Mim2Gene parser' );
  lives_ok( sub { $parser->run(); }, 'Parsed Mim2Gene map without errors' );
...
subtest 'Replay safety' => sub {
  ...
  lives_ok( sub { $parser->run(); }, 'Re-parsed Mim2Gene map without errors' );
